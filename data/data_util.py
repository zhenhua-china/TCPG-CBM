...
AWA2_DATA_DIR='D:\BaiduNetdiskDownload\OTCBM-main\AwA2-data/Animals_with_Attributes2'
CELEBA_DATA_DIR = "D:\BaiduNetdiskDownload\OTCBM-main\CelebA"
def get_dataset(args):
    ...
    if args.dataset == "awa2":
        ...
        normalizer = transforms.Normalize(mean = [0.5, 0.5, 0.5], std = [2, 2, 2])
        # print("loading.....")
        train_loader,val_loader,test_loader,_,_=generate_data(args,AWA2_DATA_DIR,resol=224)
        print(len(train_loader.dataset), "training set size")
        print(len(val_loader.dataset), "val set size")
        print(len(test_loader.dataset), "test set size")
        ...
        normalizer = transforms.Normalize(mean = [0.5, 0.5, 0.5], std = [2, 2, 2])
        # print("loading.....")
        train_loader, val_loader, test_loader, _ = generate_data(
            args.data_dir,
            resol=224,
